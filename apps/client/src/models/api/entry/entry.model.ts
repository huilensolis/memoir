...
export class EntryService extends ApiService {
    ...
    public static async createNewEntry({
        ...
        try {
            ...
            const { iv, encryptedData } = await cryptograhpyApi.encrypt(JSON.stringify(newEntry))

            const encryptedDataBase64 = Base64Parser.from_arraybuffer_to_base64(encryptedData)
