    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-xl w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">By Jane Doe</p>
        </div>
        <div className="rounded-md shadow-sm -space-y-px">
          <div className="text-pretty text-lg text-neutral-700">
            ...
            <p>
              ...
              was unparalleled. As I looked out over the sprawling landscape, I
              felt a sense of peace and tranquility that I had never experienced
              before.
            </p>
            <p>
              This trip was more than just a summer adventure. It was a journey
              of self-discovery and personal growth. It reminded me of the
              importance of stepping outside of my comfort zone and embracing
              the unknown. I returned home with a renewed sense of appreciation
              for the world around me and a desire to continue exploring.
            </p>
          </div>
        </div>
      </div>
