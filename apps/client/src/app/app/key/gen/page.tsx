    ...
    return (
        <div className="h-full min-h-screen w-full flex items-center justify-center flex-col">
            <article className="prose prose-neutral mb-10 prose-strong:font-bold">
                ...
                <strong>
                    When logging in again, you will be asked for your key to decrypt your documents; if you lose your key, you wont be able to read old documents encrypted with this key. Not even the administrators can access encrypted documents without the key.
                </strong>
            </article>
            {key && (
